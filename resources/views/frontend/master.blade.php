...
<body>
                ...
                <div class="col-md-8">
                    <div class="user-menu ">
                        <ul style="margin-top: 8px">
                            <li>
                                <p class="text-secondary">Balance : {{Auth::guard('client')->user()->balance ?? ''}} ৳</p>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <a href="{{route('home')}}"><img src="{{asset('/')}}frontend/img/logo-easy-telecom.png"></a>
                    </div>
                </div>
    ...
    <div class="mainmenu-area " style="margin-top: 8px">
        <div class="container">
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="{{route('client.history_page')}}">History</a></li>
