            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="register.html">Change Mobile No</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <h5 class="mt-2">{{auth()->guard('client')->name}}</h5>
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                ...
                                <form action="{{route('client.logout')}}" class="mr-3">
                                    @csrf
                                    <div class="d-flex">
                                        <input class="btn btn-sm btn-danger mx-auto" type="submit" value="Logout">
                                    </div>
                                </form>
                            </div>
                        </li>
