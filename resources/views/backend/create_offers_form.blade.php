    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Easy Telecom <sup></sup></div>
            </a>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="{{ route('createOffers') }}">Add Offers</a>
                        <a class="collapse-item" href="cards.html">Manage Offer</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h1 mb-4 text-gray-800">Admin Create Offer</h1>
                    ...
                    <div class="row">
                        ...
                        <form class="offer-form" method="POST" action="{{route('addOffers')}}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" id="picture" name="image" accept="image/*" required>
                            </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Easy Telecom 2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
