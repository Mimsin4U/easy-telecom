...
<div class="row bg-dark justify-content-center py-4">
    ...
    <form class="offer-form" method="POST" action="{{route('addOffers')}}" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="number" id="originalPrice" name="original_price" placeholder="Enter original price" required class="form-control">
        </div>

        <div class="form-group">
            <label for="discountPrice">Discount Price:</label>
            <input type="number" id="discountPrice" name="discount_price" placeholder="Enter discount price" required class="form-control">
        </div>
